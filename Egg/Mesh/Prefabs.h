	...
	namespace Mesh {
		...
		public:
			...
			static Egg::Mesh::Geometry::P UnitBox(ID3D12Device * device) {
				...
				Egg::Mesh::Geometry::P geometry = Egg::Mesh::VertexStreamGeometry::Create(device, reinterpret_cast<void*>(vertices), vertexBufferSize, (unsigned int)sizeof(PNTTB_Vertex));
