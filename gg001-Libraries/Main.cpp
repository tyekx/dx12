...
public:
	virtual void CreateResources() override {
		...
		DX_API("Failed to create CBV descriptor heap")
			device->CreateDescriptorHeap(&cbvHeapDesc, IID_PPV_ARGS(cbvHeap.GetAddressOf()));
		...
		cbvDesc.SizeInBytes = Egg::Utility::Align256(sizeof(ConstantBufferData));
